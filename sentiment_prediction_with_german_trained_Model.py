...
data = pd.read_excel('/content/drive/My Drive/sentimentproject/combined22and23_output.xlsx')  
...
loaded_model = TFBertForSequenceClassification.from_pretrained('/content/drive/My Drive/sentimentproject/savedDE_model')  
...
results_df.to_excel('/content/drive/My Drive/sentimentproject/predicted2223_results_one_hot.xlsx', index=False)